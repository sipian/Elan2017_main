...
(function($, _, TweenMax) {
    ...
    var home_ = {
        initialize: function() {
            ...
            this.islands = [$(".js-island-" + this.parts[0]), $(".js-island-" + this.parts[1]), $(".js-island-" + this.parts[2]), $(".js-island-" + this.parts[3]), $(".js-island-" + this.parts[4]), $(".js-island-" + this.parts[5])];
            this.prepareSounds();
            this.addInteraction();
        },
        ...
        islandClick: function(index) {
            ...
            switch (index) {
                case 0:
                    {
                        floatAnimationClass = "animation__float_01";
                        break;
                    }
                case 1:
                    {
                        floatAnimationClass = "animation__float_02";
                        break;
                    }
                case 2:
                    {
                        floatAnimationClass = "animation__float_03";
                        break;
                    }
                case 3:
                    {
                        floatAnimationClass = "animation__float_04";
                        break;
                    }
                case 4:
                    {
                        floatAnimationClass = "animation__float_05";
                        break;
                    }
                case 5:
                    {
                        floatAnimationClass = "animation__float_06";
                        break;
                    }
            }
