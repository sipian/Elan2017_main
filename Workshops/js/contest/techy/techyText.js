        ...
        <div class="text"  style="font-size:23.5px;">
            ...
            <br>
                ...
                <ul style="list-style-type: disc;">
                    ...
                    <li>Round 1(preliminary round)<br>
                    ...
                    <li>Round 2(final round)<br>
                        <ul style="list-style-type: circle;margin-left:10%;">
                            ...
                            <br>which will not exceed 15 minutes.</li>
                ...
                <ul style="list-style-type: disc;">
                    ...
                    <li>Round 1<br>
                        <ul style="list-style-type: circle;margin-left:10%;">
                            ...
                            <br>from each category progresses into the second round.</li>
                    ...
                    <li>Round 2<br>
                        <ul style="list-style-type: circle;margin-left:10%;">
                            ...
                            <br>i.e. the first in melody vs the second in melody and similarly for percussion.</li>
                            ...
                            <br>This will be done to ensure fair judging  .</li>   
                        </ul>
                    </li>
                    <li style="list-style-type: none;"><br></li>
                </ul>
            ...
            <br>
              <div class="row rules">
                ...
                <ul style="list-style-type: disc;">
                    ...
                    <li style="list-style-type: none;"><br></li>
                    <li>The judging criteria will be :<br>
                        <ul style="list-style-type: circle;margin-left:10%;">
                            <li>Script</li>
                            <br>
                            <li>Direction</li>
        ...
        <div class="text"  style="font-size:23.5px;">
           ...
           <div class="row rules">
                ...
                <ul style="list-style-type: disc;">
                    ...
                    <li>The following materials will be provided to you<br>
                        <ul style="list-style-type: circle;margin-left:10%;">
