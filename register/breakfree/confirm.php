<html>
<head>
<title>ELAN 2016 - Breakfree</title>
...
$sql2 = "SELECT * FROM breakfree WHERE ID='$_GET[ID]' AND code='$_GET[code]'";
$result2 = mysqli_query($conn, $sql2);

if (mysqli_num_rows($result2) > 0) {
    

$sql = "UPDATE breakfree SET Verified=1 WHERE ID='$_GET[ID]' AND code='$_GET[code]'";

if (mysqli_query($conn, $sql)) {
    echo "Thank you for registering for Breakfree.";
} 
