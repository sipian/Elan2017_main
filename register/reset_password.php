...
<form method="post" class="animated zoomIn" action="resetpassword.php">
<h1 class="heading">Reset Password</h1><br>
<label>Email:</label> <input type="text" name="email"><br>
<?php
if(isset($_GET['err']))
echo '<div style="color: #222">'.$_GET['err'].'</div>';
?>
<input type="submit" name="submit" id="sbutton" value="Submit">
</form>
