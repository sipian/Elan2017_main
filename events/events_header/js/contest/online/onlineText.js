function getOnlineContent(argument) {
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">PIXEL ADDA</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">ZODIAC</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">SWEET HEART</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">TWEET A TALE</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">TWIST IT</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">SKIP IT</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">TELL A TALE</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
    ...
    <div class="container">
        <div class="heading">
            ...
            <div class="col-lg-2"></div>
            <div class="col-lg-5">
                <h2> <strong style="font-weight: 900;margin-left:10%;">STATE YOUR STATUS</strong> </h2>
            </div>
            <br><br><br>
        </div>
        <div class="photo">
