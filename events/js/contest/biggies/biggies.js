...
if(events.indexOf('elanejung')==-1){$.post("../registerEvent.php",{id:_id,email:email,elanId:elanId,contest:'elanejung'},function(result){if(result!="failure"){alert('Successfully Registered For Elan E Jung');$('.elan-e-jungButton').html('DEREGISTER');events=result;}
else
alert('Some Error Ocurred While Registering');});}
else{$.post("../unregisterEvent.php",{id:_id,email:email,elanId:elanId,contest:'elanejung'},function(result){if(result!="failure"){alert('Successfully Unregistered From Elan E Jung');$('.elan-e-jungButton').html('REGISTER');events=result;}
else
...
if(verified==2){alert('Please Verify Your Mail Id First');return;}
if(events.indexOf('manthan')==-1){$.post("../registerEvent.php",{id:_id,email:email,elanId:elanId,contest:'manthan'},function(result){if(result!="failure"){alert('Successfully Registered For Manthan');$('.manthanButton').html('DEREGISTER');events=result;}
else
alert('Some Error Ocurred While Registering');});}
else{$.post("../unregisterEvent.php",{id:_id,email:email,elanId:elanId,contest:'manthan'},function(result){if(result!="failure"){alert('Successfully Unregistered From Manthan');$('.manthanButton').html('REGISTER');events=result;}
else
...
if(verified==2){alert('Please Verify Your Mail Id First');return;}
if(events.indexOf('campus_princess')==-1){$.post("../registerEvent.php",{id:_id,email:email,elanId:elanId,contest:'campus_princess'},function(result){if(result!="failure"){alert('Successfully Registered For Campus Princess');$('.campus_princessButton').html('DEREGISTER');events=result;}
else
alert('Some Error Ocurred While Registering');});}
else{$.post("../unregisterEvent.php",{id:_id,email:email,elanId:elanId,contest:'campus_princess'},function(result){if(result!="failure"){alert('Successfully Unregistered From Campus Princess');$('.campus_princessButton').html('REGISTER');events=result;}
else
