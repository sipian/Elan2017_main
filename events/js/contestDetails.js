...
<div class="heading">
  ...
  <div class="col-lg-5">
<h2> <strong style="font-weight: 900;"> ELAN-E-JUNG</strong> </h2>
  </div>
  <br><br><br>
</div>
 <div class="photo">
  <div class="row">
    <div class="col-lg-12">
     <img  class="img-thumbnail img-responsive " src="https://ae01.alicdn.com/kf/HTB1S3GNLXXXXXbXXpXXq6xXFXXXr/Living-room-home-wall-decoration-fabric-font-b-poster-b-font-Heavy-font-b-metal-b.jpg">
    </div>
  </div>
</div>
<br>
...
<div class="col-lg-6"><button type="button" class="btn btn-primary btn-lg" style="align:center;">REGISTER</button>
</div>
</div>
<br>
<div class="text">
  ...
  <br>
  <div class="row rules">
    <h2 style="text-align: center;">RULES</h2><br>
    <ul>
  ...
  <div class="row terms">
    <h2 style="text-align: center;">TERMS AND CONDITIONS</h2><br>
    <ul>
...
<div class="heading">
  ...
  <div class="col-lg-2"></div>
  <div class="col-lg-5">
<h2> <strong style="font-weight: 900;"> MANTHAN</strong> </h2>
  </div>
  <br><br><br>
</div>
 <div class="photo">
...
<div class="text">
  <div class="row title">
    <h2 style="text-align: center;font-weight: 900;">FUSION BAND COMPETITION</h2>
    <br><br>
  </div> 
  <div class="row about">
    <h2 style="text-align: center;">ABOUT</h2><br>
    ...
    <br>
    A dream of performing live, on a global scale, in front of millions of fans screaming for more. 
    <br>
    But the journey of a mile begins with the first step. 
    <br>
    Elan 2016 presents Manthan, a Fusion band contest.
    <br>
    This January, take that first step and discover what it feels like to be on the stage and get egged on by a thousand voices.
    <br>
    Make no mistake : Only the best emerges victorious at the end.
  </div>
  <br>
  <div class="row rules">
    <h2 style="text-align: center;">RULES</h2><br>
    <ul>
  <li>Bands interested in participating should upload their demos/videos with Songdew.</li>
  <li>Out of this, bands will be shortlisted, and will be performing at MANTHAN prelims, Elan 2016.</li>
  <li>2 bands will be shortlisted from the prelims round to perform at the Biggies stage.</li>
  <li>Each band will be given 20 mins to perform on stage including sound check (subject to change)</li>
  </ul>
  </div>
...
<div class="heading">
  ...
  <div class="col-lg-2"></div>
  <div class="col-lg-5">
<h2> <strong style="font-weight: 900;"> FMI</strong> </h2>
  </div>
  <br><br><br>
</div>
 <div class="photo">
...
<div class="heading">
  ...
  <div class="col-lg-2"></div>
  <div class="col-lg-5">
<h2> <strong style="font-weight: 900;"> ANGASUTRA</strong> </h2>
  </div>
  <br><br><br>
</div>
 <div class="photo">
